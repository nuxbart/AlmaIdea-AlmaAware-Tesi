...
const Home_vue_vue_type_style_index_0_scoped_f4618761_lang = "";
const _sfc_main$U = {
  __name: "Home",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="sdg_container" data-v-f4618761><!--[-->`);
...
const Home = /* @__PURE__ */ _export_sfc(_sfc_main$U, [["__scopeId", "data-v-f4618761"]]);
